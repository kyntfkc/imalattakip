// Backend repository'ye eklenecek: routes/backup.js
...
router.get('/database', auth, async (req, res) => {
  try {
    ...
    if (stderr && !stderr.includes('WARNING')) {
      ...
      // Bazı uyarılar normal, sadece hataları kontrol et
    }
    ...
    // Eğer pg_dump başarısız olursa, alternatif yöntem kullan
    try {
      const pool = require('../database/postgresql'); // PostgreSQL pool'unuz
